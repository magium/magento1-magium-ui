...
class Magium_Ui_Model_Source_TypeOptions
{
    ...
    public function toOptionArray()
    {
        ...
        $introspection = Mage::getModel('magium_ui/introspected')->getCollection();
        /* @var $introspection Magium_Ui_Model_Resource_Introspected_Collection */
        if ($this->_type) {
