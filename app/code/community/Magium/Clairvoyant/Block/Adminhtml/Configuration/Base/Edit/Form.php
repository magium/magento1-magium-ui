...
class Magium_Clairvoyant_Block_Adminhtml_Configuration_Base_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $themes = Mage::getModel('magium_clairvoyant/source_themes');
